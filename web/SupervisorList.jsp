...
<head>
    ...
    <style>
        <%-- Style sama seperti sebelum ini --%>
        :root {
            --primary: #4b2e83;
            --secondary: #6d4ac0;
            --accent: #b399d4;
...
<body>
    ...
    <div class="main-content">
        ...
        <button type="button" class="add-btn" onclick="showAddSupervisorForm()">
    ...
    <script>
        function showAddSupervisorForm() {
            Swal.fire({
                ...
                html:
                    '<form id="supervisorForm" action="SupervisorListServlet" method="post">' +
                        '<input name="supervisor_id" class="swal2-input" placeholder="Staff ID" required>' +
                ...
                focusConfirm: false,
                didOpen: () => {
                    document.getElementById('supervisorForm').addEventListener('submit', () => {
                        Swal.showLoading();
                    });
                }
            });
