...
<head>
    ...
    <style>
        ...
        .form-title { padding: 20px; font-size: 20px; font-weight: 600; color: var(--dark); }
...
<div class="main-content">
    <h2 class="form-title">F7 - Project Formulation Presentation</h2>
    ...
    <form action="SubmitF7Servlet" method="post">
        <!-- Student Info -->
        <div class="tab-content active" id="studentTab">
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="presentationDate" <%= readOnly %> required>
                </div>
                ...
                <table class="criteria-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>3</td>
                            <td><input type="number" id="score1" min="1" max="10" <%= readOnly %>></td>
                            <td><input type="number" id="mark1" name="mark1" readonly></td>
                        </tr>
                        <tr>
                            <td>Overall Organization</td>
                            <td>2</td>
                            <td><input type="number" id="score2" min="1" max="10" <%= readOnly %>></td>
                            <td><input type="number" id="mark2" name="mark2" readonly></td>
                        </tr>
                        <tr>
                            <td>Use & Quality of Materials</td>
                            <td>2</td>
                            <td><input type="number" id="score3" min="1" max="10" <%= readOnly %>></td>
                            <td><input type="number" id="mark3" name="mark3" readonly></td>
                        </tr>
                        <tr>
                            <td>Delivery Skills</td>
                            <td>3</td>
                            <td><input type="number" id="score4" min="1" max="10" <%= readOnly %>></td>
        ...
        <div class="tab-content" id="reviewerTab">
            <div class="form-section">
                ...
                <div class="form-group">
                    <label>Scoring Date</label>
                    <input type="date" name="scoringDate" <%= readOnly %> required>
                </div>
                <% if (isSupervisor) { %>
...
<script>
    ...
    document.addEventListener("input", () => {
        ...
        const m1 = s1 * 3, m2 = s2 * 2, m3 = s3 * 2, m4 = s4 * 3;
        ...
        document.getElementById('totalMarks').value = m1 + m2 + m3 + m4;
    });
</script>
</body>
</html>
