...
<%-- 
    ...
    Created on : May 28, 2025, 12:23:24 AM
    Author     : ASUS
--%>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles.css"> <%-- Optional: Externalize CSS --%>
    <style>
        * {
...
<div class="sidebar">
    ...
    <a class="nav-link active" href="#"><i>👨‍🎓</i> Students</a>

    <!-- 🔽 Insert this dropdown block here -->
    <div class="dropdown">
...
<div class="dashboard">
    <div class="top-bar">
        ...
        <div class="top-icons">
            <i>🔔</i>
            <i style="background-color:#ccc; border-radius: 50%; width: 35px; height: 35px;"></i>
        </div>
    </div>
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <tbody>
                <%-- Sample static rows, replace with database data --%>
                <tr>
                ...
                <!-- Repeat or loop with JSTL or Java code -->
            </tbody>
        </table>
    </div>
</div>
