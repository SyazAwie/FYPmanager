...
<body>
  ...
  <div class="main-content">
    <div class="card">
      ...
      <form action="UploadProgressReportServlet" method="post" enctype="multipart/form-data">
        ...
        <div class="upload-section">
          ...
          <input type="file" name="proposalFile" id="upload" required>
        </div>
  ...
  <script>
    function goBackToProgress() {
      window.location.href = "finalReport.jsp#submission-section";
    }
  </script>
</body>
</html>
