...
<head>
    ...
    <style>
        ...
        #sidebar {
            ...
            overflow-y: auto; transition: width 0.3s; z-index: 998;
        }
        ...
        #topbar {
            ...
            z-index: 999; transition: left 0.3s, width 0.3s;
        }
        #topbar.collapsed {
...
<body>
    ...
    <div class="main-content">
        ...
        <button type="button" class="add-btn" onclick="showAddExaminerForm()">
            <i class="fas fa-plus"></i> Add New Examiner
        </button>
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="examiner" items="${examinerList}">
                    <tr>
                        <td>${examiner.name}</td>
                        <td>${examiner.staffId}</td>
                        <td>${examiner.phoneNum}</td>
    ...
    <script>
        function showAddExaminerForm() {
            Swal.fire({
                ...
                html:
                    '<form id="examinerForm" action="ExaminerListServlet" method="post">' +
                        '<input name="examiner_id" class="swal2-input" placeholder="Staff ID" required>' +
                ...
                focusConfirm: false,
                didOpen: () => {
                    document.getElementById('examinerForm').addEventListener('submit', () => {
                        Swal.showLoading();
                    });
                }
            });
