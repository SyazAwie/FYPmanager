...
<html>
<head>
    <title>F10 - Poster Presentation Evaluation</title>
    <meta charset="UTF-8">
...
<div class="main-content">
    <h2 class="form-title">F10 - Poster Presentation Evaluation</h2>
            ...
            <div class="form-section">
                <table class="criteria-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>Poster Organization</td><td>1</td><td><input type="number" id="score3" min="1" max="10" <%= readOnly %>></td><td><input type="number" id="mark3" readonly></td></tr>
                        <tr><td>Research / Project Complexity Appropriate to Discipline</td><td>2</td><td><input type="number" id="score4" min="1" max="10" <%= readOnly %>></td><td><input type="number" id="mark4" readonly></td></tr>
