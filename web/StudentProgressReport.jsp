...
<head>
  ...
  <style>
    ...
    /* Proposal Card */
    .proposal-card {
      background-color: #f8c8dc; /* light pink / pastel pink */
      border-radius: 25px;
      padding: 35px;
      max-width: 650px;
...
<body>
  ...
  <div class="main-content">
    ...
    <div class="proposal-card">
      <div class="proposal-title">My Progress Report</div>
      ...
      <div class="btn-group">
         ...
         <a href="ProgressReportSubmission.jsp" class="btn btn-submit">Submit</a>
    </div>
